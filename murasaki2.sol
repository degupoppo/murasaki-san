...
contract Murasaki_Main is ERC721, Ownable{
    ...
    function stop_crafting(uint32 _summoner) public {
        ...
        uint8 _item_base_id = crafting_item_base_id[_summoner];
        uint8 _item_id = crafting_item_id[_summoner];
    ...
    function calc_crafting(uint32 _summoner) public view returns (uint32) {
        ...
        uint8 _item_base_id = crafting_item_base_id[_summoner];
        uint8 _item_id = crafting_item_id[_summoner];
        uint32 _delta_time = (_now - crafting_start_time[_summoner]);
        uint32 _dc = get_item_dc(_item_base_id, _item_id);
